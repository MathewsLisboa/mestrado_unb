...
sink("Results_Scenario3.txt")

names_results1 <- c("Estimates_Scenario3_n50", "Estimates_Scenario3_n100", "Estimates_Scenario3_n500")
names_results2 <- c("SE_Estimates_Scenario3_n50", "SE_Estimates_Scenario3_n100", "SE_Estimates_Scenario3_n500")
