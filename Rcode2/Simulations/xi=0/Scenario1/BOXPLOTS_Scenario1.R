...
boxplot(MLE_beta1_n30,MLE_beta1_n60,MLE_beta1_n100,MLE_beta1_n500, main=expression( paste("MLE for ", beta[1])),
xlab="Sample size",ylab="",names=c(30,60,100,500),outline=T,
...
boxplot(MLE_beta2_n30,MLE_beta2_n60,MLE_beta2_n100,MLE_beta2_n500, main=expression( paste("MLE for ", beta[2])),
xlab="Sample size",ylab="",names=c(30,60,100,500),outline=T,
ylim=c(-0.4,3.8), cex=1.0,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col=NULL)
abline(2.0,0,col=2,lty=2,lwd=2)

#********************MLE estimates of beta3****************#
boxplot(MLE_beta3_n30,MLE_beta3_n60,MLE_beta3_n100,MLE_beta3_n500, main=expression( paste("MLE for ", beta[3])),
xlab="Sample size",ylab="",names=c(30,60,100,500),outline=T,
ylim=c(0.25,5.15), cex=1.0,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col=NULL)
abline(3.0,0,col=2,lty=2,lwd=2)

#********************MLE estimates of sigma****************#
boxplot(MLE_sigma_n30,MLE_sigma_n60,MLE_sigma_n100,MLE_sigma_n500, main=expression( paste("MLE for ", sigma)),
xlab="Sample size",ylab="",names=c(30,60,100,500),outline=T,
...
boxplot(MLE_delta_n30,MLE_delta_n60,MLE_delta_n100,MLE_delta_n500, main=expression( paste("MLE for ", delta)),
xlab="Sample size",ylab="",names=c(30,60,100,500),outline=T,
ylim=c(-0.45,3.7), cex=1.0,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col=NULL)
abline(1.0,0,col=2,lty=2,lwd=2)
